<template>
    <div class="mt-[1px] bg-gray-100 pb-10 last:pb-0 md:mt-0 md:py-6 md:pb-6">
        <div class=" flex flex-wrap items-start gap-6 px-0 md:flex-nowrap md:px-4">
            <div class=" flex w-full flex-col gap-4 md:w-[67.62%]">
                <div class=" flex items-start gap-6 rounded bg-white p-4">
                    ...
                    <div class="w-3/4 flex flex-initial flex-col">
                        ...
                        <div class="my-2 max-w-[540px] text-base text-gray-500">
                            <div class="mb-2 flex last:mb-0"><svg stroke="currentColor" fill="currentColor"
                                    stroke-width="0" viewBox="0 0 24 24" aria-hidden="true"
                                    class="mr-2 h-6 w-6 text-gray-300" height="1em" width="1em"
                        ...
                        <div class="mb-2 max-w-[540px] text-base text-gray-500">
                            <div class="flex last:mb-0"><svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                    viewBox="0 0 20 20" aria-hidden="true"
                                    class="mr-2 flex h-6 w-6 items-center text-gray-300" height="1em" width="1em"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                        ...
                        <div class="flex max-w-[540px] items-center"><svg stroke="currentColor" fill="currentColor"
                ...
                <div role="tablist" class="tabs tabs-bordered grid grid-cols-2 overflow-auto bg-white">

<template >
    <tr class="py-2 px-2 hover:bg-slate-300 hover:cursor-pointer" @click="click" >
        ...
        <td class="hover:text-blue-500"><router-link v-if="participant.user.profileUser" :to="'/View-User/'+participant.user.profileUser.id" target="_blank">View</router-link></td>

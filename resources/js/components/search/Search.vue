<template>
    <label id="search-label" class="input input-bordered flex items-center gap-2">
        <input id="search-input" type="search" v-model="searchQuery"
        ...
        <button id="hola" @click="searchClick">
...
export default {
    ...
    name: 'Search',
    mounted() {
        let input = document.getElementById("search-label");
